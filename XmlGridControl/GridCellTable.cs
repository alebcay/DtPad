...
namespace WmHelp.XmlGrid
{
    ...
    public class GridCell
    {
        ...
        {
            get { return Owner != null ? Owner.Parent : null; }
        }

        public int Index
        {
            get { return Owner.Width * Row + Col; }
        }
        ...
        public virtual void DrawCellText(XmlGridView gridView, Graphics graphics, Font font, Brush brush, StringFormat sf, XmlGridView.DrawInfo drawInfo, Rectangle rect)
        {
            rect.Y += 2;
            //rect.Height -= 3;
    ...
    public class GridCellGroup: GridCell
    {
        ...
        {
            return (Flags & GroupFlags.TableView) != 0 ? Table[0, 1] : Table[0, 0];
        }
    ...
    public class GridRowLabel: GridCell
    {
        ...
        public override string Text
        {
            get { return RowNum > 0 ? RowNum.ToString() : ""; }
            set { }
        }
    }
    ...
    public class GridHeadLabel : GridCell
    {
        ...
        public override void DrawCellText(XmlGridView gridView, Graphics graphics, Font font, Brush brush, StringFormat sf, XmlGridView.DrawInfo drawInfo, Rectangle rect)
        {
